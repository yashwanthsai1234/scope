...
## Slice 9: Task inference from first message
...
## Slice 10: Session completion detection
...
| 9 | task inference | Task from first message |
| 10 | completion | Done/aborted on exit |
